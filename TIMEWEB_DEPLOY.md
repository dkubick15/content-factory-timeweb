...
После этого перейдите на главную страницу вашего сайта, зарегистрируйте аккаунт или войдите под существующим. В разделе настроек вы увидите статус "ИИ активен" и сможете сразу приступить к работе. Настройка персональных ключей пользователям не потребуется.
